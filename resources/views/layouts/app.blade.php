...
<link href="{{ asset('backend/assets/css/material-dashboard-rtl.css') }}" rel="stylesheet" />
<link href="{{ asset('backend/assets/css/material-dashboard.min.css') }}" rel="stylesheet" />
