...
<head>
    ...
    <style>
        @foreach($sliders as $key=>$slider)
            ...
            {
                background: url({{ url('storage/slider/'.$slider->image) }});
...
<nav id="template-navbar" class="navbar navbar-default custom-navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand display-1" href="{{ route('welcome') }}" style="font-family: 'Beth Ellen'; font-size: 22px; color: white;" >
                <h1 class="">TasteiT</h1>
                    </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="Food-fair-toggle">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="#menu-list">Featured Item</a></li>
                    ...
                    <ul id="menu-pricing" class="menu-price">
                        ...
                        @foreach($items as $item)
                            <li class="item" id="{{ $item->category->slug }}">
                                <a href="#">
                                    <img src="{{ url('storage/item/'.$item->image) }}" class="img-responsive" alt="Item" style="height: 300px; width: 369px;" >
